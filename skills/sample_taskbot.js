...
module.exports = function (controller) {
  ...
  controller.hears(['tasks', 'todo'], 'message_received', (bot, message) => {
  ...
  controller.hears(['add (.*)'], 'message_received', (bot, message) => {
  ...
  controller.hears(['done (.*)'], 'message_received', (bot, message) => {
